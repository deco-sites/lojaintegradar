  ...
  return (
    ...
    >
      <div class="customContainer">
        <AnimateOnShow animation="animate-fade-left">
          <ul class="flex flex-col gap-[60px] md:gap-[42px] md:flex-row w-full">
            {cards?.map((card) => (
        ...
        <AnimateOnShow animation="animate-fade-right">
          <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between lg:mt-20">
