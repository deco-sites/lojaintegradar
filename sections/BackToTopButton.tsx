...
export default function BackToTopButton({ text, textColor, backgroundColor }: Props) {
    return <a href="#" class="w-[84px] min-h-[84px] fixed bottom-5 lg:bottom-14 right-5 lg:right-14 z-40 bg-primary rounded-full flex flex-col items-center justify-center p-4 gap-y-1" style={{ background: backgroundColor }}>
