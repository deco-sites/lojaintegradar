...
export default function Header2({ logo = {
  ...
  barsColor, asideMenuTopBackgroundColor, visualOptimizerScript = false, asideMenuBackgroundColor, noScrollBackgroundColor, backgroundColor, dropdownMenus = {menus: []}, asideMenuCloseIconColor, headerMessage, campaignTimer, hideAsideMenu = false,
  ...
  <header>
    ...
    {visualOptimizerScript && <Head>
      <link rel="preconnect" href="https://dev.visualwebsiteoptimizer.com" />
      <script type='text/javascript' id='vwoCode' dangerouslySetInnerHTML={{__html: `
