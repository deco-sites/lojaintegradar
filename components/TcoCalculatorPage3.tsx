            ...
            <div class="py-14 px-3.5 lg:px-28 relative w-full">
                ...
                <form class="flex flex-wrap gap-[38px] mt-14 w-full" hx-on:submit={useScript(onClickNext, rootId, plans)}>
                    <label class={labeClass} style={{ animationDuration: "0.3s" }}> 
                        ...
                        <input class={inputClass} hx-on:keyup={useScript(percentageInputOnKeyUp)} type="text" placeholder={cardShare.placeholder} required id={rootId + "cardShareInput"}>
                        </input>
                    </label>
                    <label class={labeClass} style={{ animationDuration: "0.3s", animationDelay: "0.1s", opacity: "0", animationFillMode: "forwards" }}>
                        ...
                        <input class={inputClass} hx-on:keyup={useScript(percentageInputOnKeyUp)} type="text" placeholder={cardFee.placeholder} required id={rootId + "cardFeeInput"}>
                        </input>
                    </label>
                    <label class={labeClass} style={{ animationDuration: "0.3s", animationDelay: "0.2s", opacity: "0", animationFillMode: "forwards" }}>
                        ...
                        <input class={inputClass} hx-on:keyup={useScript(percentageInputOnKeyUp)} type="text" placeholder={boletoShare.placeholder} required id={rootId + "boletoShareInput"}>
                        </input>
                    </label>
                    <label class={labeClass} style={{ animationDuration: "0.3s", animationDelay: "0.3s", opacity: "0", animationFillMode: "forwards" }}>
                        ...
                        <input class={inputClass} hx-on:keyup={useScript(moneyInputOnKeyUp)} type="text" placeholder={boletoFee.placeholder} required id={rootId + "boletoFeeInput"}>
                        </input>
                    </label>
                    <label class={labeClass} style={{ animationDuration: "0.3s", animationDelay: "0.4s", opacity: "0", animationFillMode: "forwards" }}>
                        ...
                        <input class={inputClass} hx-on:keyup={useScript(percentageInputOnKeyUp)} type="text" placeholder={pixShare.placeholder} required id={rootId + "pixShareInput"}>
                        </input>
                    </label>
                    <label class={labeClass} style={{ animationDuration: "0.3s", animationDelay: "0.5s", opacity: "0", animationFillMode: "forwards" }}>
                        ...
                        <input class={inputClass} hx-on:keyup={useScript(percentageInputOnKeyUp)} type="text" placeholder={pixFee.placeholder} required id={rootId + "pixFeeInput"}>
                        </input>
                    </label>
                    <div class="w-[375px] flex flex-col gap-y-[18px] hidden">
                        <label class="w-full">
                            ...
                            <input class={inputClass} hx-on:keyup={useScript(moneyInputOnKeyUp)} type="text" placeholder={antiFraudCosts.placeholder}>
                            </input>
                        </label>
                        <label class="w-full">
                            <div class={inputCaptionClass}>
                            ...
                            <input class={inputClass} hx-on:keyup={useScript(moneyInputOnKeyUp)} type="text" placeholder={processingCosts.placeholder}>
                            </input>
                        </label>
                    </div>
                <div class="flex justify-center w-full gap-10">
                    ...
                    <button class="flex items-center gap-2.5 font-bold hover:scale-110 text-lg transition-transform text-secondary-content bg-primary rounded-lg py-2.5 px-[30px]" type="submit">
                        {nextButtonText}
