...
function TcoCalculatorPage3({ page1, rootId, page3, plans }: {
    ...
    const { title, caption, text, textFont, textWithIcon, contentTitle, asideBackground, contentTitleIcon, asideBottomText, contentCaption, contentBackground, asideTopIcon, mobileTopBanner, asideTextColor, contentCaptionColor } = page1;
    ...
    return (<div class="relative flex flex-wrap lg:flex-nowrap w-full min-h-[971px] lg:rounded-[10px] overflow-hidden hidden">
            ...
            <label class="w-full">
                ...
                <input class={inputClass} style={{borderColor: inputsBorderColor}} hx-on:keyup={useScript(moneyInputOnKeyUp)} type="text" placeholder={antiFraudCosts.placeholder}>
                </input>
            </label>
            <label class="w-full">
                <div class={inputCaptionClass} style={{color: inputsTextColor}}>
