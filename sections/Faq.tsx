...
export default function Faq({title, titleColor, caption, captionColor, questions = [], bottomTitle, bottomCaption, cta = [], questionsDivisionLineColor, questionsTitleColor, bottomCaptionColor, bottomTitleColor}: Props) {
    return <div class="max-w-[1220px] mx-auto py-12 lg:py-20 px-7">
        {title && <h2 class="text-2xl lg:text-5xl text-center leading-[120%] font-semibold mb-6" style={{color: titleColor}}>{title}</h2>}
        ...
        <div class="my-20 max-w-[768px] mx-auto">
            {questions.map((collapse) => (<div className="collapse rounded-none border-b border-base-200" style={{borderColor: questionsDivisionLineColor}}>
                ...
                <div className="collapse-title text-base lg:text-lg font-semibold flex px-7 py-6" style={{color: questionsTitleColor}}>
                    {collapse.question}
                    <div class="absolute top-8 right-4 transition-all duration-300 collapse-arrow ">
