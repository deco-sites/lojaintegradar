            ...
            <AnimateOnShow 
                ...
                delay={500}>
                    {title?.text && title.text.length > 8 && <AnimateOnShow
                        ...
                        <div class="leading-normal" dangerouslySetInnerHTML={{ __html: title.text }} style={{ color: title.color, fontFamily: title.font, fontSize: title.fontSize, letterSpacing: title.letterSpacing, lineHeight: title.lineHeight, fontWeight: title.fontWeight}} />
                    </AnimateOnShow>}
