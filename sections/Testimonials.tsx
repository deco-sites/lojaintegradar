...
function Carousel(props: Props) {
    ...
    return (<AnimateOnShow animation="animate-fade-up50" delay={300}>
      ...
      <div id={id} class="min-h-min flex flex-col lg:container md:max-w-[1332px] lg:mx-auto pt-7 lg:pt-14">
        ...
        <Slider class="carousel carousel-center w-full col-span-full row-span-full gap-9 pl-[30px] pr-[22px] py-9 md:px-9" rootId={id} interval={interval && interval * 1e3} infinite>
