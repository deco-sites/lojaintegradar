...
export default function Logos({ title, caption, logos = IMG_PLACEHODLER, }: Props) {
    logos = [...logos, ...logos];
    ...
    return (<div class="lg:container md:max-w-[1260px] lg:mx-auto px-7 md:px-0 pt-14 xl:pt-0">
