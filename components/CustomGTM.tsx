...
export default function CustomGTM() {
    ...
    const loadGTM = (gtmId: string) => {
        if (window.dataLayer)
            return; // Evita carregamento duplicado
    ...
    return (<>
            ...
            {/* NoScript fallback */}
            <noscript>
                <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5ZPJ4T" height="0" width="0" style={{ display: "none", visibility: "hidden" }}/>
            </noscript>
        </>);
}
