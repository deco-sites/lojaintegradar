...
function TcoCalculatorPage2({ page1, rootId, page2 }: {
    page1: Page1;
    page2: Page2;
    rootId: string;
}) {
    ...
    const { progressImage, currentPlatformMonthlyFee, currentPlatformComission, MontlyOrders, nextButtonText, backButtonText, nextButtonBackgroundColor, inputsTextColor, inputsBorderColor, backButtonTextColor, nextButtonTextColor, inputsNoFillErrorMessage, inputsErrorMessageColor } = page2;
            ...
            <div class="py-14 px-3.5 lg:px-28 relative w-full overflow-hidden">
                ...
                <form class="flex flex-col gap-[18px] mt-14 max-w-[375px] page2form">
                    ...
                    <div class="flex justify-end gap-10">
                        ...
                        <button class="btn btn-primary font-bold px-7 hover:scale-110 text-lg min-h-10 lg:min-h-12 h-auto "  hx-on:click={useScript(onClickNext, rootId, inputsErrorMessageColor)} style={{color: nextButtonTextColor, background: nextButtonBackgroundColor}}>
                            {nextButtonText}
