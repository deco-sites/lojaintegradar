...
export default defineApp(async (_req, ctx) => {
    ...
    <Head>
      ...
      <link rel="preload" href="https://lojaintegradar.deco.site/fonts/GalaxieCopernicus/GalaxieCopernicus-Bold.woff2" as="font" type="font/woff2" crossOrigin="anonymous"/>
      <link rel="preload" href="https://lojaintegradar.deco.site/fonts/GalaxieCopernicus/GalaxieCopernicus-Book.woff2" as="font" type="font/woff2" crossOrigin="anonymous"/>
      ...
      <link rel="stylesheet" href={asset("/fontStyles-extended.css")} media="print" onLoad="this.media='all';this.onload=null;"/>
      <noscript>
        <link rel="stylesheet" href={asset("/fontStyles-extended.css")}/>
      </noscript>

      {/* CSS de third-party (Google, reCAPTCHA): lazy load */}
      <link rel="stylesheet" href={asset("/third-party-styles.css")} media="print" onLoad="this.media='all';this.onload=null;"/>

      {/* Preload da imagem LCP (hero) - OTIMIZADO */}
      <link rel="preload" as="image" href="https://assets.decocache.com/lojaintegradar/d3c45778-c9c9-4d69-a012-3cbf03347621/bg-header-new.webp" imageSrcSet="https://sites-lojaintegradar--szzpho.decocdn.com/live/invoke/website/loaders/image.ts?src=https%3A%2F%2Fassets.decocache.com%2Flojaintegradar%2Fd3c45778-c9c9-4d69-a012-3cbf03347621%2Fbg-header-new.webp&fit=cover&width=640&height=360 640w, https://sites-lojaintegradar--szzpho.decocdn.com/live/invoke/website/loaders/image.ts?src=https%3A%2F%2Fassets.decocache.com%2Flojaintegradar%2Fd3c45778-c9c9-4d69-a012-3cbf03347621%2Fbg-header-new.webp&fit=cover&width=1920&height=1080 1920w" fetchPriority="high"/>
    ...
    <script type="module" dangerouslySetInnerHTML={{
            __html: useScript(() => {
                ...
                document.body.addEventListener('click', (e) => {
                    ...
                    if (target)
                        updateLink(target as HTMLAnchorElement);
                }, { passive: true, capture: true });
                // Atualiza links existentes no idle
                if ('requestIdleCallback' in window) {
                    requestIdleCallback(() => {
                        document.querySelectorAll('a').forEach(link => updateLink(link as HTMLAnchorElement));
                    }, { timeout: 2000 });
                }
                else {
                    setTimeout(() => {
