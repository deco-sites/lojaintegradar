...
function Carousel(props: Props) {
    const { id, title, caption, slides, backgroundImage, interval, cta } = { ...props };
    ...
    return (<div id={id} class="relative}">
        ...
        <div id={carouselId} class="min-h-min flex flex-col items-center w-full pt-7 lg:pt-14">
            ...
            <Slider class="carousel carousel-center w-full col-span-full row-span-full gap-[30px] pl-[30px] pr-[22px] py-9 md:px-9 max-w-[1332px]" rootId={carouselId} interval={interval && interval * 1e3} infinite id="carouselSlider">
