                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <div class="flex flex-col-reverse">
                                            {tab.title?.desktop && (
                                                <span
                                                    class={`hidden lg:block desktopTitle ${index ? "opacity-50" : ""
                                                        }`}
                                ...
                                <div class={`tabSecondContent ${index && 'hidden'}`}>
                                    <>
                                        ...
                                        <div className="w-full h-[1px] background-bar">
                                            <div
                                                className="h-full bg-[#D9D9D9] transition-all ease-linear progressBar w-0"
                                                style={{ animationDuration: `${tabsInterval}s` }}
                                            ></div>
                                        </div>
                                    </>
                                </div>
